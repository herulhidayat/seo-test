...
!(function () {
  ...
  if (q.autoFetchSvg && !q.fetchSvgFrom && b && b.currentScript) {
    var G = b.currentScript.getAttribute("src");
    -1 < G.search(W) &&
      (E ||
        console.info(
      ...
      (q.fetchSvgFrom = G.replace(W, "/svgs")));
  }
  if (q.fetchSvgFrom) {
  ...
  p &&
    ((Z = (b.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
      b.readyState
    )) ||
  ...
  (At.prototype = {
    ...
    then: function (t, e) {
      ...
      return (
        (!e && !t) ||
          this._handled ||
          ((this._handled = !0), this._state === ct && lt && mt(kt, this)),
    ...
    (At.resolve = function (e) {
      return e && "object" === r(e) && e.constructor === At
        ? e
        : new At(function (t) {
            t(e);
          });
        ...
        (b +=
          (v = void 0 !== g && g) && k
            ...
            ? "translate(calc(-50% + "
                ...
                .concat(u.y / Ct, "em)) ")
            : "translate(".concat(u.x / Ct, "em, ").concat(u.y / Ct, "em) ")),
        (b += "scale("
  ...
  var Yt = function () {},
    ...
    Vt = 'FA "5.15.4"',
    qt = function (t) {
      Dt.mark("".concat(Vt, " ").concat(t, " ends")),
        Dt.measure(
          "".concat(Vt, " ").concat(t),
          "".concat(Vt, " ").concat(t, " begins"),
          "".concat(Vt, " ").concat(t, " ends")
        );
    },
    Wt = {
      begin: function (t) {
        return (
          Dt.mark("".concat(Vt, " ").concat(t, " begins")),
          function () {
            return qt(t);
          }
        );
  ...
  function Bt(t, a) {
    ...
    "function" != typeof J.hooks.addPack || n
      ? (J.styles[t] = $({}, J.styles[t] || {}, r))
      : J.hooks.addPack(t, r),
      "fas" === t && Bt("fa", a);
  }
  ...
  function re(t, e, n) {
    var a,
      ...
      l =
        ...
        (o = (a = n).match(Jt)),
        (c = a.match(Qt)),
        (s = a.match(Zt)) ? (i = [s[1], s[2]]) : c && (i = c[1]),
        o && i && (r = [parseInt(o[1], 10), parseInt(o[2], 10), [], null, i]),
        r);
    l &&
      !Kt(e) &&
      (Bt(t, u({}, e, l), {
  ...
  function oe(t, e) {
    return Kt(t)
      ? "unicode/"
          .concat(Gt(t))
          .concat(void 0 === e ? "" : "-".concat(e), ".svg")
      : "".concat(t).concat(void 0 === e ? "" : "-".concat(e), ".svg");
  }
  var ce = function (r, i) {
      var t =
          2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {},
      ...
      return (
        ...
        new St(function (e, t) {
          ...
          var n = o
            ? "".concat(s, "/").concat(l, "/icons/").concat(oe(i, f))
            : "".concat(c, "/").concat(z[r], "/").concat(oe(i));
          if (
            (l && (n = "".concat(n, "?token=").concat(l)),
            J.styles[r] && J.styles[r][i])
          )
            return e(J.styles[r][i]);
          if (
            (ie[r][i].push(function (t) {
              e(t);
            }),
            1 === ie[r][i].length)
          )
  ...
  function ye(n, t) {
    ...
    if (0 === n.length) a();
      ...
      var e = be;
      et.mutateApproach === N && (e = v.requestAnimationFrame || be),
        e(function () {
          var t =
              !0 === et.autoReplaceSvg
                ? ve.replace
                : ve[et.autoReplaceSvg] || ve.replace,
            e = Wt.begin("mutate");
          n.map(t), e(), a();
        });
    }
  ...
  function Se(t) {
    ...
    return (
      ...
      o.prefix && 1 < i.length
        ? (o.iconName = ((e = o.prefix), (n = t.innerText), (ne[e] || {})[n]))
        : o.prefix &&
          1 === i.length &&
          (o.iconName = le(o.prefix, Gt(t.innerText))),
      o
    );
  }
  var Ce = function (t) {
    ...
    return new St(function (n, t) {
      ...
      if (
        (v.FontAwesomeKitConfig &&
          ...
          (r.token = v.FontAwesomeKitConfig.token),
        "fak" === c && (r.version = i),
        o && c && et.autoFetchSvg)
      )
        return ce(c, o, $({}, r))
          ...
          .catch(t);
      o && c && !et.showMissingIcons
        ? t(
            new Me(
              "Icon is missing for prefix "
                .concat(c, " with icon name ")
                .concat(o)
            )
          )
        : n(a);
  ...
  function He(h, p) {
    ...
    return new St(function (a, t) {
      ...
      if (r && "none" !== o && "" !== o) {
        ...
        if (
          (u || (u = l),
          f || (f = String.fromCharCode(parseInt(l, 16))),
          !f || (e && e.getAttribute(C) === s && e.getAttribute(O) === u))
        )
          a();
        else {
  ...
  function De(t) {
    return !(
      ...
      ~P.indexOf(t.tagName.toUpperCase()) ||
      t.getAttribute(x) ||
  ...
  var Be,
    ...
    en = function () {
      var t = (
        ...
        e = void 0 === t ? b : t;
      (0 < Object.keys(J.styles).length || et.autoFetchSvg) &&
        p &&
        et.autoReplaceSvg &&
        tn.dom.i2svg({
          node: e,
  ...
  !(function (t) {
    ...
    m &&
      (v.FontAwesome || (v.FontAwesome = tn),
      nt(function () {
        en(),
          Ae({
            treeCallback: _e,
